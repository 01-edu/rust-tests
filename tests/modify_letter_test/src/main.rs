...
mod tests {
    ...
    fn test_remove_letter_sensitive() {
        assert_eq!(remove_letter_sensitive("Jijm jis mijssjing", 'j'), "Jim is missing");
        assert_eq!(remove_letter_sensitive("Jack is missing", 'j'), "Jack is missing");
        assert_eq!(remove_letter_sensitive("Jjjijll jis mijssjjing", 'j'), "Jill is missing");
    ...
    fn test_remove_letter_insensitive() {
        ...
        assert_eq!(remove_letter_insensitive("Jim is swimming", 'A'), "Jim is swimming");
        assert_eq!(remove_letter_insensitive("JoaseA ais swiaAAAmmingA", 'A'), "Jose is swimming");
    }
    ...
    fn test_swap_letter_case() {
        ...
        assert_eq!(swap_letter_case("AaBbCcDdEEEeeeEeEe", 'e'), "AaBbCcDdeeeEEEeEeE");
    }
